                    ...
                    child:
                        ...
                        Image(
                          ...
                          errorBuilder: (context, error, stackTrace) {
                            ...
                            debugPrint('ImageView Error: $error');
                            debugPrint('ImageView URL: $url');
                            debugPrint('ImageView Type: $imageType');

                            // Show default image or placeholder on error
                            if (defaultImage != null &&
                                defaultImage!.isNotEmpty) {
                              return Image.asset(
                                defaultImage!,
                                height: size ?? height,
                                width: size ?? width,
