      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.smart_toy, color: Colors.white, size: 30.sdp),
          ),
          SizedBox(height: 16.sdp),
          Text(
            "Need Any Assistance?",
          ...
          Text(
            "Chat with our AI assistant for instant help and support. Get quick answers to your questions 24/7.",
          ...
          SizedBox(
            width: double.infinity,
            child: AppButton(
              label: 'Ask with Chatbot',
              labelStyle: 16.txtMediumWhite,
              buttonColor: AppColors.btnColor,
              radius: 20.sdp,
              onTap: () {
                context.pushNavigator(_buildChatBotScreen());
              },
            ),
          ),
        ],
