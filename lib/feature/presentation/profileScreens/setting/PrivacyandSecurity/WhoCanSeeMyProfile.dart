...
class WhoCanSeeMyProfile extends StatefulWidget {
  @override
  _WhoCanSeeMyProfileState createState() => _WhoCanSeeMyProfileState();
}

class _WhoCanSeeMyProfileState extends State<WhoCanSeeMyProfile> {
  int selectedIndex = -1;
  ...
  String? get state => ProfileCtrl.find.profileData.value.seeMyProfile;
  ...
  Future<void> _updateProfileVisibility(int index) async {
    ...
    try {
      await SettingsCtrl.find.seeProfile(selectedValue).then((value) {
  ...
  String _getDescriptionForOption(int index) {
    switch (index) {
      case 0:
        return AppStrings.anybodyCanViewProfile.tr;
      case 1:
        return AppStrings.friendsCanViewProfile.tr;
      case 2:
        return AppStrings.nobodyCanViewProfile.tr;
      default:
        return "";
    }
  }
