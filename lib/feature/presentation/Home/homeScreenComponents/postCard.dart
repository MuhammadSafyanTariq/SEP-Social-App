...
class PostCard extends StatelessWidget {
  ...
  Widget imageView(String url, {double? height, double? width, BuildContext? context}){
    final defaultHeight = MediaQuery.of(navState.currentContext!).size.height * 0.4;
              ...
              SizedBox(
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final height = data.y  ?? MediaQuery.of(context).size.height * 0.6;
                    final width = data.x  ?? MediaQuery.of(context).size.width;
  ...
  Widget build(BuildContext context) {
    ...
    RawGestureDetector(
      ...
      onScaleUpdate: (details) {
        ...
        if (details.scale == 1.0 && details.focalPointDelta.distance > 0) {
