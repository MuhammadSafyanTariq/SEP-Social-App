...
class Watermelon extends ThrowFruit {
  ...
  Watermelon(FruitGame game, double x, double y) : super(game) {
    resize(x: x, y: y);
    flyingSprite = [
      Sprite(game.images.fromCache('melancia.png')),
      Sprite(game.images.fromCache('melancia.png')),
    ];
    deadSprite = Sprite(game.images.fromCache('melancia-cut-1.png'));
    deadSprite2 = Sprite(game.images.fromCache('melancia-cut-2.png'));
    splash = Sprite(game.images.fromCache('melon_splash.png'));
  }
