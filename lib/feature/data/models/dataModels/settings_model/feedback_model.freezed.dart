...
class _$FeedbackModelImpl implements _FeedbackModel {
  const _$FeedbackModelImpl({this.status, this.code, this.message, this.data});
  ...
  @override
  String toString() {
    return 'FeedbackModel(status: $status, code: $code, message: $message, data: $data)';
  }
...
class _$DataImpl implements _Data {
  ...
  @override
  String toString() {
    return 'Data(title: $title, description: $description, image: $image, id: $id, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }
