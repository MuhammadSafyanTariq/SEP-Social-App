...
class _$LoginModelImpl implements _LoginModel {
  const _$LoginModelImpl({this.status, this.code, this.message, this.data});
  ...
  @override
  String toString() {
    return 'LoginModel(status: $status, code: $code, message: $message, data: $data)';
  }
...
abstract class _Data implements Data {
  const factory _Data({final User? user, final String? token}) = _$DataImpl;
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, email: $email, password: $password, role: $role, phone: $phone, dob: $dob, gender: $gender, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }
