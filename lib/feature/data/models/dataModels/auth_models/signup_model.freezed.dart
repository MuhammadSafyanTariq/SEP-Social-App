...
class _$SignupModelImpl implements _SignupModel {
  const _$SignupModelImpl({this.status, this.code, this.message, this.data});
  ...
  @override
  String toString() {
    return 'SignupModel(status: $status, code: $code, message: $message, data: $data)';
  }
...
class _$DataImpl implements _Data {
  ...
  @override
  String toString() {
    return 'Data(name: $name, email: $email, password: $password, role: $role, phone: $phone, dob: $dob, gender: $gender, id: $id, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }
